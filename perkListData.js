...
const perkData = {
  ...
  */
    ...
    // 342
    {
      name: "Battle Spirit", skill: DestinySkillId, skillReq: 15,
    ...
    // 343
    {
      name: "Adrenaline", skill: DestinySkillId, skillReq: 15,
    ...
    // 344
    {
      name: "Swiftness", skill: DestinySkillId, skillReq: 15,
    ...
    // 357
    {
      name: "Corrosive<br>Weapon", skill: DestinySkillId, skillReq: 25,
    ...
    // 358
    {
      name: "Leeching<br>Strikes", skill: DestinySkillId, skillReq: 25,
    ...
    // 359
    {
      name: "Unyielding", skill: DestinySkillId, skillReq: 25,
    ...
    // 368
    {
      name: "Shaman", skill: DestinySkillId, skillReq: 30,
    ...
    // 369
    {
      name: "Templar", skill: DestinySkillId, skillReq: 30,
    ...
    // 373
    {
      name: "Blood Knight", skill: DestinySkillId, skillReq: 30,
    ...
    // 377
    {
      name: "Saboteur", skill: DestinySkillId, skillReq: 30,
    ...
    // 382
    {
      name: "Addict", skill: TraitSkillId, skillReq: 0,
    ...
    // 383
    {
      name: "Adrenaline Rush", skill: TraitSkillId, skillReq: 0,
    ...
    // 384
    {
      name: "Au Naturel", skill: TraitSkillId, skillReq: 0,
    ...
    // 385
    {
      name: "Bad Natured", skill: TraitSkillId, skillReq: 0,
    ...
    // 386
    {
      name: "Bane of the Wicked", skill: TraitSkillId, skillReq: 0,
    ...
    // 387
    {
      name: "Bulwark", skill: TraitSkillId, skillReq: 0,
    ...
    // 388
    {
      name: "Defiler", skill: TraitSkillId, skillReq: 0,
    ...
    // 389
    {
      name: "Disciplined", skill: TraitSkillId, skillReq: 0,
    ...
    // 390
    {
      name: "Dovah Tinvaak", skill: TraitSkillId, skillReq: 0,
    ...
    // 391
    {
      name: "Elemental Conduit", skill: TraitSkillId, skillReq: 0,
    ...
    // 392
    {
      name: "Fast Shot", skill: TraitSkillId, skillReq: 0,
    ...
    // 393
    {
      name: "Focused", skill: TraitSkillId, skillReq: 0,
    ...
    // 394
    {
      name: "Gambler", skill: TraitSkillId, skillReq: 0,
    ...
    // 395
    {
      name: "Giantkin", skill: TraitSkillId, skillReq: 0,
    ...
    // 396
    {
      name: "Glutton", skill: TraitSkillId, skillReq: 0,
    ...
    // 397
    {
      name: "Good Natured", skill: TraitSkillId, skillReq: 0,
    ...
    // 398
    {
      name: "Hoarder", skill: TraitSkillId, skillReq: 0,
    ...
    // 399
    {
      name: "Jack of All Spells", skill: TraitSkillId, skillReq: 0,
    ...
    // 400
    {
      name: "Nosferatu", skill: TraitSkillId, skillReq: 0,
    ...
    // 401
    {
      name: "King of Worms", skill: TraitSkillId, skillReq: 0,
    ...
    // 402
    {
      name: "Light Foot", skill: TraitSkillId, skillReq: 0,
    ...
    // 403
    {
      name: "Marathon Runner", skill: TraitSkillId, skillReq: 0,
    ...
    // 404
    {
      name: "Old Fashioned", skill: TraitSkillId, skillReq: 0,
    ...
    // 405
    {
      name: "Pacifist", skill: TraitSkillId, skillReq: 0,
    ...
    // 406
    {
      name: "Rage", skill: TraitSkillId, skillReq: 0,
    ...
    // 407
    {
      name: "Skilled", skill: TraitSkillId, skillReq: 0,
    ...
    // 408
    {
      name: "Soul Reaver", skill: TraitSkillId, skillReq: 0,
    ...
    // 409
    {
      name: "Swimmer", skill: TraitSkillId, skillReq: 0,
    ...
    // 410
    {
      name: "Unbound Hands", skill: TraitSkillId, skillReq: 0,
    ...
    // 411
    {
      name: "Way of the Voice", skill: TraitSkillId, skillReq: 0,
    ...
    // 412
    {
      name: "Witcher", skill: TraitSkillId, skillReq: 0,
